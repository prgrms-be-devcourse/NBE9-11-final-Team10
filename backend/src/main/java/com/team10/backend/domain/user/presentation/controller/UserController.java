...
import com.team10.backend.domain.user.application.dto.req.ConsentUpdateReq;
import com.team10.backend.domain.user.application.dto.req.OneWonStartReq;
import com.team10.backend.domain.user.application.dto.req.OneWonVerifyReq;
import com.team10.backend.domain.user.application.dto.res.ConsentRes;
import com.team10.backend.domain.user.application.dto.res.IdentityVerificationStatusRes;
import com.team10.backend.domain.user.application.dto.res.OcrAcceptedRes;
import com.team10.backend.domain.user.application.dto.res.OneWonStartRes;
import com.team10.backend.domain.user.application.dto.res.OneWonVerifyRes;
import com.team10.backend.domain.user.application.dto.res.UserRes;
import com.team10.backend.domain.user.application.service.IdentityVerificationService;
import com.team10.backend.domain.user.application.service.UserConsentService;
import com.team10.backend.domain.user.application.service.UserProfileService;
