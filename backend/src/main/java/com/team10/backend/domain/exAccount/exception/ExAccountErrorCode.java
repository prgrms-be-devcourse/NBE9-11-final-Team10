...
public enum ExAccountErrorCode implements ErrorCode {
    ...
    EX_ACCOUNT_CANDIDATE_ALREADY_CLAIMED(HttpStatus.CONFLICT, "이미 처리 중인 계좌 연동 요청입니다. 다시 조회해주세요."),
    EX_ACCOUNT_CONCURRENT_SYNC(HttpStatus.CONFLICT, "현재 계좌 연동 또는 동기화가 진행 중입니다. 잠시 후 다시 시도해주세요.");
